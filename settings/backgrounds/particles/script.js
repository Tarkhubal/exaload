tsParticles.load("tsparticles", {
  ...
  backgroundMask: {
    ...
    cover: { color: { value: "#ff0000" }, opacity: 1 },
    enable: false,
  },
  ...
  interactivity: {
    ...
    modes: {
      ...
      light: {
        area: {
          gradient: { start: { value: "#ff0000" }, stop: { value: "#000000" } },
          radius: 1000,
        },
  ...
  particles: {
    ...
    color: {
      value: "#ff0000",
      animation: {
        h: { count: 0, enable: false, offset: 0, speed: 0.1, sync: true },
        s: { count: 0, enable: false, offset: 0, speed: 0.1, sync: true },
        l: { count: 0, enable: false, offset: 0, speed: 0.1, sync: true },
      },
    },
    destroy: {
      mode: "none",
    ...
    links: {
      ...
      frequency: 1,
      opacity: 1,
      shadow: { blur: 5, color: { value: "#ff0000" }, enable: false },
    ...
    move: {
      ...
      attract: { distance: 150, enable: false, rotate: { x: 600, y: 1200 } },
      decay: 0,
      distance: {},
      direction: "none",
      drift: 0,
